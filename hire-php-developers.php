...
<!--#include file="header.shtml"-->
 ...
 <section class="service-topbanner hirephpbannerbg">      
      <div class="container">
          <div class="row service-flex">
              <div class="col-md-6">
                <div class="mainservicetopbanner">
                  <!-- <h3>Hire Certified iPhone App Developer</h3> -->
                  <h1 class="wordpress_head">Hire Dedicated PHP Developers</h1>
                    <p>Hire PHP developers from StartDesigns for 50% cost saving and 2X faster delivery. Our team of dedicated developers builds future-ready websites and applications. Our PHP programmers possess experience of more than 5+ years on average and have expertise working on the PHP frameworks like CodeIgniter, Laravel, Symfony, CakePHP, etc.</p>
                  <div class="dflex">
              ...
              <div class="col-md-6">
                <div class="rightside-topbanner wpbanner-top">
                  ...
                  <img src="images/hire-phpp.png" alt="banner-img">
                </div>
              </div>
          </div>
      </div>     
          ...
          <div class="col-md-6">
              <div class="img_outer">
                <div class="reactleftimages">
                  <img src="images/dedicated-phpp.jpg" class="responsive web-smal floating" alt="image">
                </div>
              </div>                
          </div> 
          <div class="col-md-6 web3-contents">    
          <h2>Hire <span class="web-theme-color">PHP Developer</span></h2>           
            <p class="para">Hire Start Designs for optimal PHP programming. Our php developers are experts in PHP coding and development who can create reliable and function effective websites. We understand your requirements well and accordingly deliver perfect web applications for you.                          
            </p>
  ...
  <section class="webflowfeatures_services webdtech-page hphp-page bg-gray-white hiree">
  <div class="container">
    <div class="title">         
      <h2>Benefits of Hire
        <a href="" class="typewrite" data-period="2000" data-type='[  "PHP Developer" ]'> 
        </a>
      </h2>
    </div>
    ...
    <div class="row weoffer-row1">
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            ...
            <span class="sub-head">Dedicated PHP developers are experienced and skilled enough. That makes the development process much faster and the workflow of the build websites and apps are bug-free and more professional.
            </span>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            ...
            <span class="sub-head">When you hire PHP developers on flexible time modules, then you get a high return on investment. Because you can choose developers based on your requirements only.
            </span>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            <div class= "DamlContentHead">
              <div class="pink_bordr_icon"><img src="images/business-oriented.png "></div>             
            </div>
            <h4>Business Oriented Approach</h4>
            <span class="sub-head">With having working experience in different projects and industries, the approach of developers is more business-oriented. So, you track the complete process of web or app development.
            </span>
          </div>
        </div>
      </div> 
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            <div class= "DamlContentHead">
              <div class="pink_bordr_icon"><img src="images/delivery-time.png "></div>             
            </div>
            <h4>On-time Delivery</h4>
            <span class="sub-head">A team of dedicated developers ensures on-time delivery. With having enough resources, the launch of your project is never delayed, and the money you invested gets paid off.
            </span>
          </div>
        </div>
      </div>    
