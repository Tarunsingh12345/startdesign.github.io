...
<!--#include file="header.shtml"-->
 ...
 <section class="service-topbanner hiremagentobannerbg">      
          ...
          <div class="row service-flex">
              <div class="col-md-6">
                <div class="mainservicetopbanner">
                  <!-- <h3>Hire Certified iPhone App Developer</h3> -->
                  <h1 class="wordpress_head">Hire Magento Developer</h1>
                    <p>Hire Magento developers for seamless ecommerce solutions for websites made on Magento. Our developers build feature reach, customer-centric, high performance, and SEO-friendly e-commerce stores. Our developers have expertise in custom development, theme development, extension development, third-party integration, migration, and maintenance or support services for Magento websites.</p>
                  <div class="dflex">
    ...
    <section class="about-reactjs web3-benefit ecome-page hiree">
      <div class="container">
        ...
        <div class="row row-waffer">         
          ...
          <h2>Hire <span class="web-theme-color">Magento Developer</span></h2>           
            <p class="para">Magento is currently the most popular e- commerce development platform. It provides creation and marketing of viable, feature rich, highly customized, scalable, updated e-commerce stores which can contribute to immense growth in business. It also offers best control and flexibility over content and functioning of your e-store. Hire specialized magento developers at start designs on hourly, weekly or full time basis for creation, designing, customization and management of your e-commerce store in a cost effective way.                          
            </p>
  ...
  <section class="webflowfeatures_services webdtech-page hmagento-page bg-gray-white hiree">
  <div class="container">
    <div class="title">         
      <h2>Benefits of Hire
        <a href="" class="typewrite" data-period="2000" data-type='[  "Magento Developer" ]'> 
        </a>
      </h2>
    </div>
    ...
    <div class="row weoffer-row1">
        ...
        <div class="damlBox">
          <div class="DamlContent ">
            <div class= "DamlContentHead">
              <div class="pink_bordr_icon"><img src="images/user-experience (1).png"></div>              
            </div>
            <h4>Highly Skilled and Experience</h4>
            <span class="sub-head">We have a team of dedicated Magento developers. Our developers are highly skilled and possess 3 years of experience on average. We have delivered 100+ Magento projects since we started.
            </span>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            ...
            <span class="sub-head">We have an in-house team of developers that allow us to provide cost-effective Magento development solutions for any size of projects and business requirements.
            </span>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            <div class= "DamlContentHead">
              <div class="pink_bordr_icon"><img src="images/management-icon.png "></div>             
            </div>
            <h4>Top-class Management</h4>
            <span class="sub-head">You will get the benefits of timely reporting and a well-managed project. So, you can track the ongoing process and share your feedback with developers to implement it.
            </span>
          </div>
        </div>
      </div> 
      <div class="col-md-3">
        <div class="damlBox">
          <div class="DamlContent ">
            ...
            <span class="sub-head">You will get reliable support even after the delivery of the projects. Our developers provide 24/7 support to resolve any bugs and malfunctioning appear on your Magento e-commerce store.
            </span>
          </div>
        </div>
      </div>    
    ...
    <section class="use-technological dev-tech-2 technological_developer bg-gray-white">
      <div class="container">
        <div class="title">
